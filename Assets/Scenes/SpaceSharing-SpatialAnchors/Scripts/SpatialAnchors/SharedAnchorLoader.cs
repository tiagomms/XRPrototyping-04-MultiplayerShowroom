...
public static class SharedAnchorLoader
{
    ...
    {
        Assert.IsNotNull(SampleController.Instance, $"{nameof(SampleController)}.Instance");
        Assert.IsNotNull(SampleController.Instance.anchorPrefab, $"{nameof(SampleController)}.anchorPrefab");
